...
class Inspector1(object):
    ...
    def __init__(self, env, buffer1, buffer2, buffer4, 
                 measurements : Measurements, st : ServiceTimes,
                 facility : System, buff_work1 : System, buff_work2 : System, buff_work3 : System):
        self.env = env
...
class Inspector2(object):
    ...
    def __init__(self, env, buffer3, buffer5, measurements : Measurements, st : ServiceTimes,
                 facility : System, buff_work2 : System, buff_work3 : System):
        self.env = env
